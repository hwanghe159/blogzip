...
class SeleniumBlogMetadataScrapperTest {
    ...
    @Test
    fun `thread safe 테스트`() {
        val datas: MutableList<BlogMetadataScrapper.BlogMetadata> =
        ...
        ).map { url -> Thread { datas.add(seleniumBlogMetadataScrapper.getMetadata(url)) } }
